      ...
      <main>
        <header class="jumbotron">
          <div class="container text-center">
            <div>
              <h1 class="display-4">Toyota FT 86</h1>
              <span class="text-muted">Brand : Toyota</span>
            </div>
          </div>
        </header>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <h3>
                  Price :{" "}
                  <span class="badge badge-primary">Rp. 900.000.000</span>
                </h3>
              </div>
            </div>
          </div>
          ...
          <div class="row mb-3">
            ...
            <div class="col-md-12">
              <div class="form-group">
                <h3>
                  Nominal/Month :{" "}
                  <span class="badge badge-primary">Rp. 10.000.000</span>
                </h3>
              </div>
            </div>
