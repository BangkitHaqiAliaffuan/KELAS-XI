...
const EducatorAuth = () => {
  ...
  // Redirect if signed in but not an educator (regular student)
  if (isLoaded && isSignedIn && !isEducator) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="px-8 py-6">
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                ...
                <p className="text-sm text-amber-700 mt-1">
                  Only educators invited to the Edemy organization with "educator" role can access this portal.
                </p>
                <p className="text-sm text-amber-700">
                  Regular students do not need organization membership.
                </p>
              </div>
            </div>
          </div>

          {/* Sign In Button - Login Only, No Signup */}
          <SignInButton 
            mode="modal"
          ...
          {/* Warning about signup */}
          <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
            <p className="text-sm text-red-700 text-center">
              <strong>No self-registration:</strong> New accounts created here will be redirected to student portal. 
              Educator access requires invitation to organization.
            </p>
          </div>
