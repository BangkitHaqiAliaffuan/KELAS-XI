      ...
      <nav class="navbar navbar-expand-lg sticky-top bg-primary navbar-dark">
        <div class="container">
          ...
          <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
            <li>
              <a href="discover-games.html" class="nav-link px-2 text-white">
                Discover Games
              </a>
            </li>
            <li>
              <a href="manage-games.html" class="nav-link px-2 text-white">
                Manage Games
              </a>
            </li>
            <li>
              <a href="profile.html" class="nav-link px-2 text-white">
                User Profile
              </a>
            </li>
            <li class="nav-item">
