...
const timelineDays: TimelineDay[] = [
  ...
  },
  {
    ...
    description: "Proses Pencampuran Tanah Dengan Pupuk, dan Penanaman Rumpu",
    icon: "Leaf",
    color: "bg-primary-green",
    image: "/days/day4.JPG",
  },
  {
    day: 5,
    title: "Penanaman",
    description: "Menanam Tanaman, Membuat Deskorasi Tanaman, dan Membuat Konten Medsos",
    icon: "Flower",
    color: "bg-secondary-green",
    image: "/days/day5.JPG",
  },
  {
    day: 6,
    title: "Dekorasi",
    description: "Membuat Lanjutan Dekorasi Untuk Taman ",
    icon: "Trophy",
    color: "bg-accent-green",
    image: "/days/day6.JPG",
  },
    ...
    <section className="relative py-20 px-4 md:px-8 bg-cream-bg">
      ...
      <div className="relative z-20 max-w-3xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="boldonse-regular text-5xl md:text-6xl font-bold text-primary-green mb-4">Perjalanan Tanam hingga Panen</h2>
              ...
              <div key={idx} className={`flex gap-6 md:gap-8 ${idx % 2 === 0 ? "md:flex-row" : "md:flex-row-reverse"}`}>
                ...
                <div className={`flex-1 ${idx % 2 === 0 ? "md:text-right" : "md:text-left"} relative z-20`}>
                  ...
                  >
                    ...
                    <h3 className="chelsea-market-regular text-2xl font-bold mb-2">{item.title}</h3>
