...
class PickupController extends Controller
{
    ...
    public function store(Request $request): JsonResponse
    {
        $validated = $request->validate([
            ...
            // Improvement: pakai Rule::exists agar valid slug selalu sinkron dengan DB,
            // tidak perlu update hardcoded array setiap ada kategori baru.
            'trash_types.*'         => ['required', 'string', Rule::exists('waste_categories', 'type')],
        ]);
