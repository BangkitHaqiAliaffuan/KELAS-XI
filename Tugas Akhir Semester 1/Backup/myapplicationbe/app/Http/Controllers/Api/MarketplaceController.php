...
class MarketplaceController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $paginator = MarketplaceListing::with('seller') // Improvement: Eager load seller
            ->active()
            ->byCategory($category)
    ...
    {
        $listing = MarketplaceListing::with('seller')->active()->findOrFail($id); // Improvement: Eager load seller
